...
class Queries {
    ...
    private static $querymap = array(
        "company" => array(
            ...
            "information-little" => "SELECT `name`, COUNT(company_tables.id) as `tables` FROM company,company_table WHERE company.name = ? AND company.id = company_table.company_id",

            "information-all" => "SELECT `name`,COUNT(company_tables.id) as `tables` FROM company,company_table WHERE company.name = ? AND company.id = company_table.company_id",
